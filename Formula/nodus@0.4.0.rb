class NodusAT040 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/nodus-rs/nodus/releases/download/v0.4.0/nodus-v0.4.0-aarch64-apple-darwin.tar.gz"
      sha256 "758cadd776d825bcf03c08a2a62f977c5f04458735512442a0e01b6b6e2d10c8"
    else
      url "https://github.com/nodus-rs/nodus/releases/download/v0.4.0/nodus-v0.4.0-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/nodus-rs/nodus/releases/download/v0.4.0/nodus-v0.4.0-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "c68087e8356dfa6f58b256453ea0f47f4fa59904be8f94b8cc27c75ee4803a36"
    else
      url "https://github.com/nodus-rs/nodus/releases/download/v0.4.0/nodus-v0.4.0-x86_64-unknown-linux-gnu.tar.gz"
